"""
Standardize VolLiqScore (Factor 3) Outputs - All Timeframes

This script generates VolLiqScore data for ALL timeframes:
...
def standardize_volliqscore_for_symbol_timeframe(
    ...
    if not input_path.exists():
        logger.warning(f"  Raw bars file not found: {input_path.name}")
        return False
...
def main():
    ...
    logger.info("=" * 80)
    logger.info("VolLiqScore Standardization - All Timeframes")
    logger.info("=" * 80)
